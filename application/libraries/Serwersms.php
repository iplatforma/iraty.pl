...
class Serwersms
{
    ...
    //----------------------------------------------------------------------------------------------------------------------------------------//
    public static $DaneKonta = [
        'login' => 'webapi_platforma',
        'haslo' => 'Platforma091#'
    ];
    ...
    public static function mms_z_dysku($plik)
    {
        if (is_uploaded_file($plik['tmp_name'])) {
            ...
            return SerwerSMS::pliki([plik_mms => $f]);
